...
// ============================================================================
// SCRIPT 07b2: HYCOM — TENDENCIAS DE SALINIDAD EN 500 m Y 1000 m
// ----------------------------------------------------------------------------
// PROPÓSITO:
//   Complementar el análisis de salinidad superficial (script 07b1) con
//   los niveles profundos: 500 m y 1000 m. Completar la "fotografía
//   vertical" de la salinidad del Atlántico Norte en 1993-2023.
//
// HIPÓTESIS:
//   Si la estratificación creciente del Atlántico subpolar (ya detectada
//   entre 0 m y 100 m en el script 07b1) es real, esperamos que los
//   niveles profundos (500 m, 1000 m) muestren patrones distintos:
//   los procesos de convección profunda débil dejarían a estos niveles
//   relativamente aislados de la variabilidad superficial.
//
// SALIDA:
//   · Tabla con 14 filas (7 regiones × 2 niveles profundos) con tendencia,
//     tau y p-valor de la salinidad.
// ============================================================================
...
var BANDAS_SAL = ['salinity_500', 'salinity_1000'];
...
var feats_500m = regiones_lista.map(function(r) {
  return calcular_tendencia(r.nombre, r.geometria, 'salinity_500', '500 m');
});

var feats_1000m = regiones_lista.map(function(r) {
  return calcular_tendencia(r.nombre, r.geometria, 'salinity_1000', '1000 m');
});
...
// ----------------------------------------------------------------------------
print('==================================================================');
print('SCRIPT 07b2 — TENDENCIAS DE SALINIDAD HYCOM (500 m y 1000 m)');
print('==================================================================');
...
print('');
print('TABLA DE TENDENCIAS DE SALINIDAD HYCOM PROFUNDA:');
print(resultados);