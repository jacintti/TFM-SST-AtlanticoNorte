...
// ============================================================================
// SCRIPT 07c1: HYCOM — TENDENCIAS DE TEMPERATURA EN 0 m Y 100 m
// ----------------------------------------------------------------------------
// PROPÓSITO:
//   Calcular tendencias Mann-Kendall + Sen's slope para la temperatura
//   HYCOM en los niveles 0 m y 100 m, sobre las siete regiones del trabajo,
//   durante 1993-2023 (31 años completos de HYCOM).
//
//   Objetivo: comparar tendencias térmicas HYCOM con las de OISST (1982-2024)
//   y MODIS (2003-2021) en superficie, e introducir la dimensión vertical
//   a 100 m que ningún otro producto del trabajo aporta.
//
//   Validación cruzada esperada: HYCOM 0 m debería dar tendencias coherentes
//   con OISST y MODIS para regiones bien muestreadas (GSE, EUR, CBL, T53).
//   Discrepancias potenciales en LAB y NOR donde HYCOM puede capturar señales
//   que MODIS no recoge por nubosidad/hielo.
//
// SALIDA:
//   · Tabla con 14 filas (7 regiones × 2 niveles) con tendencia, tau, p-valor.
// ============================================================================
...
var BANDAS_TEMP = ['water_temp_0', 'water_temp_100'];
...
var hycom_diario = hycom_raw.map(function(img) {
  ...
  // Máscara térmica solo sobre la temperatura de superficie
...
var feats_0m = regiones_lista.map(function(r) {
  return calcular_tendencia(r.nombre, r.geometria, 'water_temp_0', '0 m');
});

var feats_100m = regiones_lista.map(function(r) {
  return calcular_tendencia(r.nombre, r.geometria, 'water_temp_100', '100 m');
});
...
// ----------------------------------------------------------------------------
print('==================================================================');
print('SCRIPT 07c1 — TENDENCIAS DE TEMPERATURA HYCOM (0 m y 100 m)');
print('==================================================================');
...
print('');
print('TABLA DE TENDENCIAS DE TEMPERATURA HYCOM:');
print(resultados);